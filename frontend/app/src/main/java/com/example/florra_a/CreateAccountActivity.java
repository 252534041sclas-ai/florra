...
public class CreateAccountActivity extends AppCompatActivity {
    ...
    private void registerCustomer(String fullName, String email, String mobile, String password, String otp) {
        Toast.makeText(this, "Creating account...", Toast.LENGTH_SHORT).show();

        RegisterRequest request = new RegisterRequest(fullName, email, mobile, password, otp);
        RetrofitClient.getApiService().registerCustomer(request).enqueue(new Callback<AuthResponse>() {
            @Override
