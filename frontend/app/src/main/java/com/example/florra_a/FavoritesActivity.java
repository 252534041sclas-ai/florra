...
public class FavoritesActivity extends AppCompatActivity implements TileAdapter.OnItemClickListener {
    ...
    private void updateUI(List<Product> list) {
        ...
        if (list.isEmpty()) {
            ...
            // Set Adapter
            adapter = new TileAdapter(this, list);
    ...
    public void onBookmarkClick(Product product) {
        // Toggle from favorites screen means removal
        com.example.florra_a.network.ApiService apiService = com.example.florra_a.network.RetrofitClient.getApiService();
        apiService.removeFromFavorites(product.getId()).enqueue(new retrofit2.Callback<okhttp3.ResponseBody>() {
            ...
            public void onResponse(retrofit2.Call<okhttp3.ResponseBody> call, retrofit2.Response<okhttp3.ResponseBody> response) {
                 if (response.isSuccessful()) {
                     ...
                     loadFavorites(); // Reload to update list
                 } else {
