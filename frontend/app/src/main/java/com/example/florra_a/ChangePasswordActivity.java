...
import com.example.florra_a.models.ChangePasswordRequest;
...
public class ChangePasswordActivity extends AppCompatActivity {
    ...
    private void updatePassword() {
        ...
        ChangePasswordRequest request = new ChangePasswordRequest(email, currentPassword, newPassword);
                ...
                if (response.isSuccessful()) {
                    ...
                    try {
                        if (response.errorBody() != null) {
                            // Try to parse error message if it's JSON {"error": "..."} or just plain text
